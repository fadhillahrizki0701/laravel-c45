...
<pre class="mt-2">usia;BB_TB;Menu;Keterangan
                ...
                <div class="btn-group">
                    ...
                    <form action="{{ route('dataset2.split') }}" method="POST" onsubmit="return confirm('Split Dataset?');" class="d-inline">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" step="0.01" min="0.1" max="0.9" value="0.8" class="form-control rounded-0" placeholder="Split Ratio" aria-label="Split Ratio" aria-describedby="split-ratio" name="split_ratio">
